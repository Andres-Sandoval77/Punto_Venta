		...
		<div class="login-form">
			<div class="sign-in-htm">
				<div class="group">
					<br>
					<br>
					<form name="inicio" action="verifica_user.php" method="post">
					<label for="user" class="label">Ingrese nombre de usuario</label>
			...
			<!--<div class="for-pwd-htm">
				<div class="group">
					<label for="user" class="label">Ingrese correctamente el nombre de usuario</label>
