...
$this->Cell(50,2,'Oswaldo Avalos',0,1,'L');
...
$pdf->Cell(50,4,'',0,0,'C');
$pdf->Cell(50,4,'Universidad Insurgentes, Plantel CD.Azteca ' . $dia_num . ' de ' . $mes . ' de ' . $anio . '.',0,1,'L');
...
$pdf->Cell(50,4,'',0,0,'C');
$pdf->Cell(100,4,'LISTADO DE VENTAS',1,1,'C',1);
$pdf->Cell(50,4,'',0,0,'C');
$pdf->Cell(5,4,'No',1,0,'C',1);
$pdf->Cell(50,4,'Nombre del producto',1,0,'C',1);
$pdf->Cell(45,4,'Catidad',1,0,'C',1);
$pdf->Ln();
$consulta=mysqli_query($conn,"select codigo_barras, sum(a.cantidad) from tbl_entradas a group by codigo_barras;");
...
$pdf->Cell(45,4,'Catidad',1,0,'C',1);
$pdf->Ln();
$consulta=mysqli_query($conn,"select codigo_barras, sum(a.cantidad) from tbl_ventas a group by codigo_barras;");
$filas=mysqli_num_rows($consulta);
$i=0;
while ($i<$filas) {
		while ($row= mysqli_fetch_array($consulta)){
